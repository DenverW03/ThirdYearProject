...
int main(int argc, char* argv[]) {
    ...
    robots[0] = SimpleRobot((ModelPosition *)world.GetModel(argv[2]), Pose::Random(-8, 8, -8, 8), robots);
    robots[1] = SimpleRobot((ModelPosition *)world.GetModel(argv[3]), Pose::Random(-8, 8, -8, 8), robots);
    robots[2] = SimpleRobot((ModelPosition *)world.GetModel(argv[4]), Pose::Random(-8, 8, -8, 8), robots);
    world.Start();
