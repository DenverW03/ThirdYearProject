...
g++ main.cpp ../common/src/SimpleRobot.cpp -o main -I /opt/homebrew/Cellar/fltk/HEAD-ecb3e40/include -L /opt/homebrew/Cellar/fltk/HEAD-ecb3e40/lib -l fltk -I /usr/local/include/Stage-4.3/ -L /usr/local/lib/ -l stage.4.3.0;